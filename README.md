...
| 시나리오           | 평균 보상     | 평균 비용      | 서비스 레벨 | Bullwhip 비율 | 특성 설명            |
|--------------------|---------------|----------------|--------------|----------------|-----------------------|
| **BASELINE**       | -1,301.46     | 130,146        | 0.987        | 0.156          | 표준 수요 패턴       |
| **HIGH_VOLATILITY**| -12,781.59    | 2,291,353      | 0.949        | 0.334          | 수요 변동성 극대화   |
| **SEASONAL**       | -12,866.11    | 2,313,064      | 0.950        | 0.251          | 계절적 수요 패턴     |
